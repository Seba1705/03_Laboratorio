...
function cargarArrayDeObjetos() {
    ...
    (localStorage.length > 0) ? console.log('EL localStorage no esta vacio') : arrayDeObjetos.forEach(function (element) {
...
function buscarEnArray(correo, pass) {
}
